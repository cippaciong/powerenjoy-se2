...
\begin{Goal}{admin_new_safeareas}{An admin must be able to add and delete safe areas and power grid stations}
	%REQUIREMENTS
...
\begin{Goal}{admin_management}{An administrator must be able to add new administrator providing an email, a name and a passowrd}
