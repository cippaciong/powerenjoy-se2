...
\begin{Goal}{car_management}{An administrator must be able to manage cars: add a new car and delete an existing one, see and change the status and the details of a selected car}
	%REQUIREMENTS
...
\begin{Goal}{user_management}{An admin must be able to manage users: add a new user and delete an existing one; see and update details, payment information and the status of a selected user}
